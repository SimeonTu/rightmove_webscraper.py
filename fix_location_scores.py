#!/usr/bin/env python3
"""
Fix Location Scores Script

This script manually updates location scores for properties that have location_score = 0
by using postcode-based distance estimation and manual corrections.
"""
...
def main():
    ...
    for idx, row in zero_location.iterrows():
        ...
        # Try to get distance from postcode
        if postcode:
    ...
    # Save the fixed CSV
    output_file = 'results/enhanced_scrape_2025-Oct-15_at_18h49m/enhanced_properties_with_scores_fixed.csv'
