#!/usr/bin/env python3
"""
Property Analysis and Scoring Script
...
def main():
    ...
    output_file = "/Users/simeontu/Documents/vscode-projects/rightmove_webscraper.py/results/enhanced_scrape_2025-Oct-15_at_18h49m/enhanced_properties_with_scores.csv"
    ...
    avg_size = df_with_size['property_size_sqm'].mean()
    logger.info(f"Average property size: {avg_size:.1f} sqm")
